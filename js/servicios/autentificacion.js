'use strict'
//authData este es el objeto que nos devuelve Firebase del usuario ya registrado
app.factory("Aut", function(FBURL, $firebaseAuth, $firebaseObject) {
	...
	var Aut = {
        ...
        //Esta funcion que se activa en el registro nos crea un nodo con los usuarios
        //Esto es obcional
		...
		registro: function(usuario){
			return aut.$createUser({
                ...
                //Esta funcion nos crea en la base de datos los usuarios con el nodo usuarios
